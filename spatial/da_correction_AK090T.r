...
# Run subpopulation correction for AK090T
obj_cosmx <- process_subpopulation(LoadSeuratRds("/mnt/jinstore/Archive01/pxg353/05.SpacialData/DropSeq.Endo.5kGenes.rds"), LoadSeuratRds("for_jasmine/obj_merged_AK090T_annotated.rds"))
...
ggsave("for_jasmine/umap_endocrine_AK090T.png",
    DimPlot(obj_cosmx,
        dims = c(2, 1),
        reduction = "umap",
        shuffle = TRUE,
...
obj_cosmx_full <- LoadSeuratRds("for_jasmine/obj_merged_AK090T_annotated.rds")
...
SaveSeuratRds(obj_cosmx_full, "for_jasmine/obj_merged_AK090T_annotated.rds")
