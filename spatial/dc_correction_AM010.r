...
# Run subpopulation correction for AM010
obj_cosmx <- process_subpopulation(LoadSeuratRds("/mnt/jinstore/Archive01/pxg353/05.SpacialData/DropSeq.Endo.5kGenes.rds"), LoadSeuratRds("for_jasmine/obj_merged_AM010_annotated.rds"), pca_dims = 1:15)
...
ggsave("for_jasmine/umap_endocrine_AM010.png",
    DimPlot(obj_cosmx,
        dims = c(2, 1),
        reduction = "umap",
        shuffle = TRUE,
...
obj_cosmx_full <- LoadSeuratRds("for_jasmine/obj_merged_AM010_annotated.rds")
...
SaveSeuratRds(obj_cosmx_full, "for_jasmine/obj_merged_AM010_annotated.rds")
