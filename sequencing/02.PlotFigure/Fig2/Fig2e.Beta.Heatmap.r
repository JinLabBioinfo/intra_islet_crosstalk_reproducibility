...
t2d_file <- file.path(raw_obj_dir, "00.RawObj", "Disease_Status_Beta_All.rds")
aging_file <- file.path(raw_obj_dir, "01.GSEA", "Age_Beta_Healthy.rds")
bmi_file <- file.path(raw_obj_dir, "01.GSEA", "BMI_Beta_Healthy.rds")
genes_up_file <- file.path(gene_dir, "UP.Beta.genes")
genes_dn_file <- file.path(gene_dir, "Dn.Beta.genes")
...
pdf(file = "Fig2e.Beta.Heatmap.pdf", width = 5, height = 5)
pheatmap(
